                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Jorge Tenazoa Dorado', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                                            Text('Solicita Bicicleta', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                                            Text('BMX ROJA', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                                            Text('Por 1 Hora', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                ElevatedButton(
                                                  ...
                                                  child: Icon(Icons.clear, color: Color.fromARGB(255, 255, 255, 255), size: 20),
                                                ),
                                              ],
                                            ),
                                          ],
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(
                                flex: 2, // Ajusta el flex del primer contenedor para ocupar más ancho
                                child: Container(
                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Jorge Tenazoa Dorado', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    ),
                              ...
                              SizedBox(width: 10), // Ajusta el espacio entre los contenedores
                               ...
                               Expanded(
                                flex: 1, // Ajusta el flex del segundo contenedor para ocupar menos ancho
                                child: Container(
                                  padding: const EdgeInsets.all(13),
                                  margin: const EdgeInsets.symmetric(horizontal: 0),
                                  decoration: BoxDecoration(
                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Roger Chavez Medina', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    ),
                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Wagner Villasis Hidalgo', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    ),
                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Luisa Medina Quispe', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    ),
                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Victor Medina Vilcatoma', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    ),
                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Wilmer Chavez Medina', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    ),
                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Elena Gutierrez', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    ),
                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Diandra Da Costa', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    ),
                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Elide Portocarrero', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    ),
                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Michel Cisneros Llatas', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    ),
                                    ...
                                    child: Container(
                                      child: Center(
                                        child: Column(
                                          ...
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text('Bryan Diaz Vargas', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ),
                                    ),
